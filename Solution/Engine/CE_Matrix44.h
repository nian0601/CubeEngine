...
template <typename T>
CE_Matrix44<T>::CE_Matrix44(const CE_Matrix44<T>& aMatrix)
{
	for (unsigned char i = 0; i < 16; ++i)
	{
...
template <typename T>
void CE_Matrix44<T>::Init(T* aDataPointer)
{
	for (unsigned char i = 0; i < 16; ++i)
	{
...
template <typename T>
CE_Vector3<T> operator*(const CE_Vector3<T>& aVector, const CE_Matrix44<T>& aMatrix)
{
	return CE_Vector3<T>(
...
template <typename T>
CE_Vector4<T> operator*(const CE_Vector4<T>& aVector, const CE_Matrix44<T>& aMatrix)
{
	return CE_Vector4<T>(
...
template <typename T>
bool operator==(const CE_Matrix44<T>& aFirstMatrix, const CE_Matrix44<T>& aSecondMatrix)
{
	for (unsigned char i = 0; i < 16; ++i)
	{
...
template <typename T>
CE_Matrix44<T> operator+=(CE_Matrix44<T>& aFirstMatrix, const CE_Matrix44<T>& aSecondMatrix)
{
	for (unsigned char i = 0; i < 16; ++i)
	{
...
template <typename T>
CE_Matrix44<T> operator+(const CE_Matrix44<T>& aFirstMatrix, const CE_Matrix44<T>& aSecondMatrix)
{
	CE_Matrix44<T> result(aFirstMatrix);
...
CE_Matrix44<T> operator*=(CE_Matrix44<T>& aFirstMatrix, const CE_Matrix44<T>& aSecondMatrix)
{
	CE_Matrix44<T> originalFirst(aFirstMatrix);
...
template <typename T>
CE_Matrix44<T> operator*(const CE_Matrix44<T>& aMatrix, float aScalar)
{
...
template <typename T>
CE_Matrix44<T> operator*=(CE_Matrix44<T>& aMatrix, float aScalar)
{
...
template <typename T>
CE_Matrix44<T> CE_Matrix44<T>::CreateRotateAroundX(T aAngleInRadians)
{
	CE_Matrix44<T> M;
...
template <typename T>
CE_Matrix44<T> CE_Matrix44<T>::CreateRotateAroundY(T aAngleInRadians)
{
	CE_Matrix44<T> M;
...
template <typename T>
CE_Matrix44<T> CE_Matrix44<T>::CreateRotateAroundZ(T aAngleInRadians)
{
	CE_Matrix44<T> M;
...
template<class T>
CE_Matrix44<T> CE_Matrix44<T>::RotateAroundAxis(const CE_Vector3<T>& aAxis, T aAngleInRadians)
{
	//http://paulbourke.net/geometry/rotate/
	//CE_Vector4<T> startPoint(aPoint.x, aPoint.y, aPoint.z, 1.f);
	//Matrix44<T> transform;
	//transform.SetPos(-startPoint);
	//transform.myMatrix[15] = 1;
	//
	//Matrix44<T> TInverse = CE_InverseSimple(transform);



	//CE_Vector3<T> U = CE_GetNormalized(aAxis);
	//if (U.x < 0.1f && U.y < 0.1f && U.z < 0.1f)
	//{
	//	return CE_Matrix44<float>();
	//}
	//
	//float a = U.x;
	//float b = U.y;
	...
	//}
	//
	//Matrix44<T> RxInverse = CE_InverseSimple(Rx);
	//
	//
	//Matrix44<T> Ry;
	//Ry.myMatrix[0] = d;
	...
	//Ry.myMatrix[10] = d;
	//
	//Matrix44<T> RyInverse = CE_InverseSimple(Ry);
	//
	//
	//Matrix44<T> Rz;
	...
	//
	//
	////CE_Matrix44<T> finalMatrix = TInverse * RxInverse * RyInverse * Rz * Ry * Rx * transform;
	//CE_Matrix44<T> finalMatrix =  RxInverse * RyInverse * Rz * Ry * Rx ;
...
CE_Matrix44<T> CE_InverseSimple(const CE_Matrix44<T>& aMatrix)
{
	...
	inverse.SetPos(CE_Vector4<float>(0, 0, 0, 1.f));
	translation *= -1.f;
	translation.w = 1.f;
...
template <typename T>
void CE_Matrix44<T>::SetPos(const CE_Vector3<T>& aPos)
{
	myMatrix[12] = aPos.x;
	myMatrix[13] = aPos.y;
	myMatrix[14] = aPos.z;
...
template <typename T>
void CE_Matrix44<T>::SetPos(const CE_Vector4<T>& aPos)
{
	myMatrix[12] = aPos.x;
	myMatrix[13] = aPos.y;
	myMatrix[14] = aPos.z;
...
template <typename T>
void CE_Matrix44<T>::SetUp(const CE_Vector3<T>& anUp)
{
	myMatrix[4] = anUp.x;
	myMatrix[5] = anUp.y;
	myMatrix[6] = anUp.z;
...
template <typename T>
void CE_Matrix44<T>::SetRight(const CE_Vector3<T>& aRight)
{
	myMatrix[0] = aRight.x;
	myMatrix[1] = aRight.y;
	myMatrix[2] = aRight.z;
...
template <typename T>
void CE_Matrix44<T>::NormalizeRotationVectors()
{
...
template <typename T>
CE_Vector3<T> CE_Matrix44<T>::GetPos() const
{
	return CE_Vector3<T>(myMatrix[12], myMatrix[13], myMatrix[14]);
}

template <typename T>
CE_Vector4<T> CE_Matrix44<T>::GetPos4() const
{
	return CE_Vector4<T>(myMatrix[12], myMatrix[13], myMatrix[14], myMatrix[15]);
}

template <typename T>
CE_Vector3<T> CE_Matrix44<T>::GetForward() const
{
	return CE_Vector3<T>(myMatrix[8], myMatrix[9], myMatrix[10]);
}

template <typename T>
CE_Vector3<T> CE_Matrix44<T>::GetUp() const
{
	return CE_Vector3<T>(myMatrix[4], myMatrix[5], myMatrix[6]);
}

template <typename T>
CE_Vector3<T> CE_Matrix44<T>::GetRight() const
{
...
template<typename T>
CE_Matrix44<T> CE_Matrix44<T>::CreateOrthogonalMatrixLH(T aWidth, T aHeight, T aNearZ, T aFarZ)
{
	CE_Matrix44 temp;
...
template <typename T>
void CE_Matrix44<T>::NormalizeVector(T* aMatrixEntry)
{
	CE_Vector3<T> vector(aMatrixEntry[0], aMatrixEntry[1], aMatrixEntry[2]);
	Normalize(vector);
...
//Typdefs
typedef CE_Matrix44<float> CE_Matrix44f;