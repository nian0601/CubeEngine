...
template <typename T>
CE_Matrix33<T>::CE_Matrix33(const CE_Matrix33<T>& aMatrix)
{
	for (unsigned char i = 0; i < 9; ++i)
	{
...
template <typename T>
CE_Vector3<T> operator*(const CE_Vector3<T>& aVector, const CE_Matrix33<T>& aMatrix)
{
	return CE_Vector3<T>(
...
template <typename T>
CE_Vector2<T> operator*(const CE_Vector2<T>& aVector, const CE_Matrix33<T>& aMatrix)
{
	CE_Vector3<T> v(aVector.x, aVector.y, 1);

	v = v * aMatrix;

	return CE_Vector2<T>(v.x, v.y);
}

template <typename T>
bool operator==(const CE_Matrix33<T>& aFirstMatrix, const CE_Matrix33<T>& aSecondMatrix)
{
	for (unsigned char i = 0; i < 9; ++i)
	{
...
template <typename T>
CE_Matrix33<T> operator+=(CE_Matrix33<T>& aFirstMatrix, const CE_Matrix33<T>& aSecondMatrix)
{
	for (unsigned char i = 0; i < 9; ++i)
	{
...
template <typename T>
CE_Matrix33<T> operator+(const CE_Matrix33<T>& aFirstMatrix, const CE_Matrix33<T>& aSecondMatrix)
{
	CE_Matrix33<T> result(aFirstMatrix);
...
CE_Matrix33<T> operator*=(CE_Matrix33<T>& aFirstMatrix, const CE_Matrix33<T>& aSecondMatrix)
{
	CE_Matrix33<T> originalFirst(aFirstMatrix);
...
inline void operator*=(CE_Vector3<Type> &aVector, const CE_Matrix33<Type> &aMatrix)
{
	aVector = aVector * aMatrix;
}

template<typename Type>
inline void operator*=(CE_Vector2<Type> &aVector, const CE_Matrix33<Type> &aMatrix)
{
	aVector = aVector * aMatrix;
}

template <typename T>
CE_Matrix33<T> operator*(const CE_Matrix33<T>& aMatrix, float aScalar)
{
...
template <typename T>
CE_Matrix33<T> operator*=(CE_Matrix33<T>& aMatrix, float aScalar)
{
...
template <typename T>
CE_Matrix33<T> CE_Matrix33<T>::CreateRotateAroundX(T aAngleInRadians)
{
	CE_Matrix33<T> M;
...
template <typename T>
CE_Matrix33<T> CE_Matrix33<T>::CreateRotateAroundY(T aAngleInRadians)
{
	CE_Matrix33<T> M;
...
template <typename T>
CE_Matrix33<T> CE_Matrix33<T>::CreateRotateAroundZ(T aAngleInRadians)
{
	CE_Matrix33<T> M;
...
template<class T>
CE_Matrix33<T> CE_Matrix33<T>::CreateReflectionMatrixAboutAxis(CE_Vector3<T> aReflectionVector)
{
	CE_Matrix33<T> reflectionMatrix;
...
template <typename T>
void CE_Matrix33<T>::Rotate2D(T aRadian)
{
	CE_Matrix33<T> temp = CreateRotateAroundZ(aRadian);
	CE_Matrix33<T> temp2 = *this;
...
template <typename T>
void CE_Matrix33<T>::SetRotation2D(T aAngleInRadians)
{
...
CE_Matrix33<T> CE_InverseSimple(const CE_Matrix33<T>& aMatrix)
{
	...
	CE_Vector3<float> translation = inverse.GetPos3();
...
template <typename T>
void CE_Matrix33<T>::SetPos(const CE_Vector2<T>& aPos)
{
	myMatrix[6] = aPos.x;
	myMatrix[7] = aPos.y;
}
...
template <typename T>
void CE_Matrix33<T>::SetPos(const CE_Vector3<T>& aPos)
{
	myMatrix[6] = aPos.x;
	myMatrix[7] = aPos.y;
	myMatrix[8] = aPos.z;
...
template <typename T>
CE_Vector3<T> CE_Matrix33<T>::GetPos3() const
{
	return CE_Vector3<T>(myMatrix[6], myMatrix[7], myMatrix[8]);
}

//Typedefs
typedef CE_Matrix33<float> CE_Matrix33f;