	...
	, myInput(anInput)
{
	...
	input.myKeyboardMapping[DEBUG_F1] = DIK_F1;
	input.myKeyboardMapping[DEBUG_F2] = DIK_F2;
	input.myKeyboardMapping[DEBUG_F3] = DIK_F3;
	input.myKeyboardMapping[DEBUG_F4] = DIK_F4;
